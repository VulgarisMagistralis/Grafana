...
with open("noph.json") as json_file:
...
dbClient = InfluxDBClient('localhost' , 8086 , 'root' , 'root' , 'CAMessageLog7')
dbClient.drop_database('CAMessageLog7')
dbClient.create_database('CAMessageLog7')
