...
with open("roc_braccini_22_sol.json") as json_file:
...
dbClient = InfluxDBClient('localhost' , 8086 , 'root' , 'root' , 'CAMessageLog6')
dbClient.drop_database('CAMessageLog6')
dbClient.create_database('CAMessageLog6')
